...
<template>
  <div ref="root" class="sgg">
    <span class="sgg-heading">start.gg account <span class="sgg-required">(required)</span></span>
    <p class="sgg-hint">
      Search your gamer tag or paste your profile URL. Links your tag so it can be
      pulled by bracket on the sharing site.
    </p>
